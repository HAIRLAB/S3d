...
lambda1 = 1100;  %the regularization parameter 
...
lambda2 = 1150;  %the regularization parameter 
...
lambda3 = 1000;  %the regularization parameter 
...
err2 = abs([(0.5 -imag(w2(12)))/0.5,(1 -imag(w2(9)))]);
...
err3 = abs([(0.5 -imag(w3(12)))/0.5,(1 -imag(w3(9)))]);
