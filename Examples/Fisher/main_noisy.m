...
parameter.x_num_to_fit = 12; % number of points to use in polynomial interpolation for spatial derivatives
parameter.t_num_to_fit = 12; % number of points to use in polynomial interpolation for time derivative
...
rng('default');
rng(0);
index = randperm(17500,10000)+7500;
...
lambda = 0.09; % the regularization parameter 
